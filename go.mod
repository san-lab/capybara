...
require (
	github.com/Shirikatsu/go-ethereum v1.8.20-0.20200110102301-c4e7114b4f04 // indirect
	...
	github.com/clearmatics/ion-cli v0.0.0-20200205113655-d9f2ef285dc6 // indirect
